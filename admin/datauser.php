...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="datauser.php"><em class="fa fa-user">&nbsp;</em> Data User</a></li>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            $result = mysqli_query($koneksi, "SELECT id,username,nama,tanggal_lahir,alamat FROM user WHERE level='user'") or die(mysqli_error($koneksi));
                            ...
                            <tr>
                                ...
                                <td> <a href="#"><button class="btn btn-success btn-md">Cek</button></a> </td>
                            </tr>
                            <?php
                            }
