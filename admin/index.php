        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 caption">
                    ...
                    <?php echo "<h1>Hallo, Dokter ".$_SESSION['nama']."</h1> " ?>

                    <p>Pada Halaman ini Anda dapat mengelola, basis pengetahuan dari sistem pakar ini, silahkan klik tombol Dashboard untuk mengelola basis pengetahuan</p>

                    <a href="dashboard.php" class="btn btn-transparent">Dashboard</a>
